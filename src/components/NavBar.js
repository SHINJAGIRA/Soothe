...
const NavItem = ({ icon, label, isActive, onClick }) => (
  <li
    className={`flex items-center p-3 rounded-xl transition-all duration-200 hover:bg-pink-500/30 group cursor-pointer
...
const NavBar = () => {
  ...
  return (
    <>
      ...
      <nav className="hidden sm:flex lg:hidden fixed top-0 left-0 h-screen w-20 bg-gray-100 dark:bg-gray-800 border-r border-pink-300/20 flex-col items-center p-10 z-10 shadow-lg">
