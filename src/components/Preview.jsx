...
import { faHeart, faComment, faPaperPlane, faChevronLeft, faChevronRight } from '@fortawesome/free-solid-svg-icons';
              ...
              {mediaFiles.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md text-gray-800 dark:text-gray-200 rounded-full p-3 shadow-md hover:bg-white dark:hover:bg-gray-700 transition-all duration-300"
                  >
                    <FontAwesomeIcon icon={faChevronLeft} />
                  </button>
                  <button
                    onClick={handleNextMedia}
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md text-gray-800 dark:text-gray-200 rounded-full p-3 shadow-md hover:bg-white dark:hover:bg-gray-700 transition-all duration-300"
                  >
